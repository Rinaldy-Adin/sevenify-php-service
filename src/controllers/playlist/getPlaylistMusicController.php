...
class GetPlaylistMusicController
{
    function get(): string
    {
        ...
        $playlistModels = PlaylistService::getInstance()->getPlaylistMusic($playlist_id);
        $searchResult = array_map(fn(MusicModel $model) => $model->toDTO(), $playlistModels);
